...
data = np.genfromtxt('/home/nikit/Desktop/jnj/coronary_heart_disease/saheart_1_withheader.csv',delimiter=',')
...
with tf.Session() as session:
    ...
    plt.title('COST AND ACCURATELY predicted after each epoch for 62 images')
    plt.show()
    session.close()
